...
vim.api.nvim_set_keymap('n', '<leader>do', [[<cmd>lua require('telescope.builtin').diagnostics({bufnr = 0})<CR>]], { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', 'gI', [[<cmd>lua require('telescope.builtin').lsp_implementations({jump_type = 'vsplit'})<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'gt', [[<cmd>lua require('telescope.builtin').lsp_type_definitions()<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'gT', [[<cmd>lua require('telescope.builtin').lsp_type_definitions({jump_type = 'vsplit'})<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'gd', [[<cmd>lua require('telescope.builtin').lsp_definitions()<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'gD', [[<cmd>lua require('telescope.builtin').lsp_definitions({jump_type = 'vsplit'})<CR>]], { noremap = true, silent = true })
